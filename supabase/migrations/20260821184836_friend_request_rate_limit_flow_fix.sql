-- Keep repeat taps idempotent and let an incoming request become an
-- acceptance without treating it as a new outbound request.
...
revoke all on function public.request_friendship_by_username(text)
  from public, anon;
