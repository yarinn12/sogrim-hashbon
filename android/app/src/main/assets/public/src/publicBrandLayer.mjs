  ...
  return `
    <nav class="product-app-nav" aria-label="&#1504;&#1497;&#1493;&#1493;&#1496; &#1512;&#1488;&#1513;&#1497;">
      <button class="product-nav-button" data-action="home" data-nav-destination="home" type="button">
        <svg viewBox="0 0 24 24" focusable="false" aria-hidden="true"><path d="M4.5 11.5 12 5l7.5 6.5"/><path d="M6.5 10.5v8h11v-8"/><path d="M10 18.5v-4h4v4"/></svg>
        <span>&#1489;&#1497;&#1514;</span>
      </button>
      <button class="product-nav-button" data-action="home" data-nav-destination="events" type="button">
        <svg viewBox="0 0 24 24" focusable="false" aria-hidden="true"><rect x="4" y="5.5" width="16" height="14" rx="2.5"/><path d="M8 3.5v4M16 3.5v4M4 9.5h16"/></svg>
        <span>&#1488;&#1497;&#1512;&#1493;&#1506;&#1497;&#1501;</span>
      </button>
      <button class="product-nav-button" data-action="edit-profile" data-nav-destination="profile" type="button">
        <svg viewBox="0 0 24 24" focusable="false" aria-hidden="true"><path d="M12 12a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z"/><path d="M4.8 20a7.2 7.2 0 0 1 14.4 0"/></svg>
        <span>&#1508;&#1512;&#1493;&#1508;&#1497;&#1500;</span>
      </button>
    </nav>
  `;
...
function syncHeaderNavState() {
  const screen = document.querySelector("#app .screen");
  const nav = screen?.querySelector(".product-app-nav");
  ...
  const showPrimaryNav = primaryNavScreens.has(kind);
  nav.hidden = !showPrimaryNav;
  nav.inert = !showPrimaryNav;
  if (showPrimaryNav) {
  ...
  const eventDestinations = new Set(["event", "settlement", "join-event", "groups"]);
...
function renderBrandMark() {
  return `
    <span class="product-brand-mark" aria-hidden="true">
      <img class="product-brand-image" src="./brand-mark-v3.png" alt="" width="1024" height="1024" />
    </span>
  `;
}
...
function detectBrandScreenKind(screen) {
  ...
  if (["home", "event", "join-event", "new-event", "groups"].includes(explicitKind)) {
    return explicitKind;
  }
