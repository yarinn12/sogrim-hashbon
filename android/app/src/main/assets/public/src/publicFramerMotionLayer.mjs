  ...
  sections.forEach((section, index) => {
    motion.animate(
      section,
      {
        opacity: [0.78, 1],
        x: [12, 0],
        clipPath: ["inset(0 2% 0 0 round 10px)", "inset(0 0 0 0 round 10px)"]
      },
      {
        duration: 0.28,
...
function animateDialogOpen() {
  ...
  motion.animate(
    panel,
    {
      ...
      y: [18, 0],
      scale: [0.985, 1],
      clipPath: ["inset(3% 0 0 0 round 12px)", "inset(0 0 0 0 round 12px)"]
    },
    {
      duration: 0.3,
      ease: [0.22, 1, 0.36, 1]
...
function animateNotice() {
  ...
  motion.animate(
    ...
    {
      opacity: [0.55, 1],
      clipPath: ["inset(0 10% 0 0 round 8px)", "inset(0 0 0 0 round 8px)"]
    },
    {
      duration: 0.28,
      ease: [0.22, 1, 0.36, 1]
