...
def build():
    ...
    save_jpeg(social_card(lockup, 960, 540), ROOT / "assets" / "sogrim-logo-intro-poster.jpg")
    ...
    for folder, (legacy_size, foreground_size) in icon_sizes.items():
        ...
        save_png(icon_canvas(mark, legacy_size, occupancy=0.72), destination / "ic_launcher.png")
        save_png(icon_canvas(mark, legacy_size, occupancy=0.72), destination / "ic_launcher_round.png")
        if foreground_size:
            save_png(
